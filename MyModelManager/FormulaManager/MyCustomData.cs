...
namespace MyModelManager
{
    public class MyCustomSingleData : DynamicObject
    {
        ...
        {
            Dictionary<string, MyPropertyInfo> result = new Dictionary<string, MyPropertyInfo>();
        ...
        {
            MyPropertyInfo result = new MyPropertyInfo();
        ...
        private void OnProperyCalled(MyPropertyInfo property, string relationshipTailToProperty = "")
        {
            ...
            {
                PropertyCalled(this, new PropertyCalledArg() { CalledProperty = property, RelationshipPathToTargetProperty = relationshipTailToProperty });
            }
        }
