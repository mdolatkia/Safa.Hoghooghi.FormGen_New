...
{
    public class RadarChartReportResolver
    {
        //List<ReportGroupDTO> ReportGroups { set; get; }
        public RadarChartReportResolver(DR_Requester requester, int reportID, RR_ReportSourceRequest request, Unit initialReportWidth)
        {
