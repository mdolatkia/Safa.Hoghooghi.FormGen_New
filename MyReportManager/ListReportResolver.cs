    ...
    public class ListReportResolver
    {
        ...
        private void SetReportDataSource(Report report)
        {
            if (objectDataSource == null)
            {
                ...
                objectDataSource.DataSource = searchRequestManager.GetDataTableBySearchDataItems(Request.Requester, ListReportReportDTO.TableDrivedEntityID, Request.SearchDataItems, ListReportReportDTO.EntityListView.EntityListViewAllColumns, 1000, Request.OrderByEntityViewColumnID, Request.SortType).Item2;
            }
